...
3. [Analyze a Single Playlist](#analyze-a-single-playlist)
4. [Get One Song in Playlist](#get-one-song)
5. [Audio Features for One Song](#one-song-features)
6. [Analyze Multiple Playlists](#analyze-multiple-playlists)
7. [Analyze a User's Tracks](#analyze-user-tracks)
8. [Charting Data](#charting-data)
9. [Categories and Bins](#categories)
10. [Sorting Dataframes](#sorting)
11. [Networks](#networks)
12. [Louvain Community Detection](#louvain)
...
##  <span style="color:olive"> Get One Song in a Playlist </span> <a name="get-one-song"></a>
...
##  <span style="color:olive"> Get Audio Features for One Song </span> <a name="one-song-features"></a>
We can take a look at an **individual track** here:

While this information is already a lot (!), we can extract some perhaps-more-interesting features of tracks via the Audio Features method. Using *spotipy_client.audio_features(track_id)*, we easily get track's audio features (by track_id):


```
sample_track_audio_features = pd.DataFrame(spotipy_client.audio_features(sample_track["id"]))
...
##  <span style="color:olive"> Categorization:  From Continuous to Discrete Variables </span> <a name="categories"></a>
...
##  <span style="color:olive">Networks </span> <a name="networks"></a>
...
### And Example:  Network of Students
...
----
### A Network Example Using Spotify Data
...
### Louvain Communities and The Ghost In the Machine:
